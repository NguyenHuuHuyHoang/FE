...
var chinhSua = function(maSV){
    ...
    .then(function(res){
        render(res.data);
        document.getElementById('btnCapNhatSinhVien').style.display = "block";
        document.getElementById('btnThemSinhVien').style.display = "none";
...
function render(res){
    document.getElementById('MaSV').value = res.MaSV;
    document.getElementById('HoTen').value = res.HoTen;
    document.getElementById('Email').value = res.Email;
    document.getElementById('SoDT').value = res.SoDT;
    document.getElementById('DiemToan').value = res.DiemToan;
    document.getElementById('DiemLy').value = res.DiemLy;
    document.getElementById('DiemHoa').value = res.DiemHoa;
}
...
document.getElementById('btnCapNhatSinhVien').onclick = function(){
    ...
    document.getElementById('btnCapNhatSinhVien').style.display = "none";
    document.getElementById('btnThemSinhVien').style.display = "block";
